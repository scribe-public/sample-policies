...
```json
              ...
              "summary" : "Data Source has support for identity",
              "summary" : "License Threat Group is 'Banned'",
              "summary" : "License Threat Group is 'Weak Copyleft'",
              "summary" : "License Threat Group is '[unassigned]'",
              "summary" : "License Threat Group is not 'Microsoft'",
              "summary" : "License Threat Group is not 'Oracle'",
...
```json
              ...
              "reason" : "Did not find 'BSD' license",
              ...
              "reason" : "Did not find 'BSD-3-Clause' license",
...
<!-- { "object-type": "command-output-start" } -->
```yaml
name: sonatype-policy
path: sonatype.rego
description: "Verify a report against a set of rules"
...
evidence:
  ...
  labels:
    - sonatype
  sbomversion: sha256:7f4ee3c4065d67489d175a88e67d2496f428a03a82693eff19c563129e39be22
...
<!-- { "object-type": "command-output-start" } -->
```bash
valint verify busybox:latest -D error --rule sonatype.yml --output-file sonatype-sarif.json
```
```bash
Error: policy check failed, Policies [default] failed with the following errors.
* rule [sonatype-policy] failed

[0;90m[2024-05-22 18:58:07][0m [0;31mERROR[0m policy check failed, Policies [default] failed with the following errors.
* rule [sonatype-policy] failed
...
{
  "text": "278 violations | Denied policies: [\"License-Banned\"] | Minimum threat level: 9 | Denied reason substrings: [\"(severity = 7.5)\"].\n{\n  \"policy_name\": \"License-Banned\",\n  \"reason\": \"Denied policy violation\",\n  \"violation_id\": \"cdedcd78dbca4255b7aba9657c237d3d\"\n}",
  "markdown": "278 violations | Denied policies: [\"License-Banned\"] | Minimum threat level: 9 | Denied reason substrings: [\"(severity = 7.5)\"].\n{\n  \"policy_name\": \"License-Banned\",\n  \"reason\": \"Denied policy violation\",\n  \"violation_id\": \"cdedcd78dbca4255b7aba9657c237d3d\"\n}"
}
{
