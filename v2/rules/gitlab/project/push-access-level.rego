...
match_any_level(branch) {
    some rule in branch.result_object.branch_protection.push_access_levels
...
push_access_level_error() = v {
	some branch in input.evidence.predicate.content[_].branch
	branch.name == name
	branch.result_object.branch_protection.push_access_levels == null
	v = {
		"branch": branch.name,
	}
}
...
push_access_level_error() = v {
	...
	v = {
		"project": branch.name,
		"available_rules": branch.result_object.branch_protection.push_access_levels,
	}
}
