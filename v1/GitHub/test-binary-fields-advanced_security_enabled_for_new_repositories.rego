...
verify = v {
	v := {
		"allow": allow,
		"violation": {
			"type": "A rule to verify that the binary field: advanced_security_enabled_for_new_repositories is properly set",
			"details": violations,
		},
		"summary": [{
			"allow": allow,
...
violations = j {
	j := [r |
        ...
        organization_details.advanced_security_enabled_for_new_repositories != desired_value
		...
		r := {
            ...
            "tested_binary_field": "advanced_security_enabled_for_new_repositories",
        }
	]
}
