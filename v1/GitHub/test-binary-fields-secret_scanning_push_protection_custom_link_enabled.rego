...
verify = v {
	v := {
		"allow": allow,
		"violation": {
			"type": "A rule to verify that the binary field: secret_scanning_push_protection_custom_link_enabled is properly set",
			"details": violations,
		},
		"summary": [{
			"allow": allow,
...
violations = j {
	j := [r |
        ...
        organization_details.secret_scanning_push_protection_custom_link_enabled != desired_value
		...
		r := {
            ...
            "tested_binary_field": "secret_scanning_push_protection_custom_link_enabled",
        }
	]
}
