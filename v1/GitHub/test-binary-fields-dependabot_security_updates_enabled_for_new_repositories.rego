...
verify = v {
	v := {
		"allow": allow,
		"violation": {
			"type": "A rule to verify that the binary field: dependabot_security_updates_enabled_for_new_repositories is properly set",
			"details": violations,
		},
		"summary": [{
			"allow": allow,
...
violations = j {
	j := [r |
		...
		r := {
            ...
            "tested_binary_field": "dependabot_security_updates_enabled_for_new_repositories",
        }
	]
}
