...
verify = v {
	v := {
		"allow": allow,
		"violation": {
			"type": "A rule to verify that the binary field: dependency_graph_enabled_for_new_repositories is properly set",
			"details": violations,
		},
		"summary": [{
			"allow": allow,
...
violations = j {
	j := [r |
        ...
        organization_details.dependency_graph_enabled_for_new_repositories != desired_value
		...
		r := {
            ...
            "tested_binary_field": "dependency_graph_enabled_for_new_repositories",
        }
	]
}
