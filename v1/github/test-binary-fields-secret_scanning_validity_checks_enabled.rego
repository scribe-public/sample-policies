...
verify = v {
	v := {
		"allow": allow,
		"violation": {
			"type": "A rule to verify that the binary field: secret_scanning_validity_checks_enabled is properly set",
			"details": violations,
		},
		"summary": [{
			"allow": allow,
...
violations = j {
	j := [r |
		...
		r := {
            ...
            "tested_binary_field": "secret_scanning_validity_checks_enabled",
        }
	]
}
