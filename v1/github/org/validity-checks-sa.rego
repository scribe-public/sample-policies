...
violations = j {
	j := [r |
		...
		secret_scanning_validity_checks := organization.result_object.organization_details.secret_scanning_validity_checks_enabled 
...
# Define the function to check secret_scanning_validity_checks status
