...
| Name | Description |
|------|-------------|
| [OWASP Top 10 Security Controls](https://deploy-preview-299--scribe-security.netlify.app/docs/configuration/initiatives/owasp-top10-sc) | This initiative implements a policy to verify compliance with the OWASP Top 10 Security Controls.  |
...
| [CNCF SSCP Initiative](https://deploy-preview-299--scribe-security.netlify.app/docs/configuration/initiatives/cncf) | Evaluate the compliance of a project with the CNCF Software Suuply Chain Best Practices Framework |
